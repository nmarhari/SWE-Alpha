...
def step_impl(context):
    ...
    # assert("t" in log[-1]['message'][log[-1]['message'].find("a:"):log[-1]['message'].find("a:")+10][-5:-1])
...
def step_impl(context):
    ...
    print(log[-1]['message'][log[-1]['message'].find("b:"):log[-1]['message'].find("b:")+6][3:6])
    assert("f" in log[-1]['message'][log[-1]['message'].find("b:"):log[-1]['message'].find("b:")+6][3:6])
